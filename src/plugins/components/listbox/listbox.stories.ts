...
export const Main: Story = {
  ...
  args: {
    ...
    items: html`
      ${languages.map(
        (item, index) => html`
          <div class="ale-listbox-option">
            <span class="font-sans">${item.name}</span>
            ${index === 0
              ? html`
                  <div class="ale-listbox-selected-icon">
                    <svg
                      class="ale-listbox-selected-icon-inner"
                      xmlns="http://www.w3.org/2000/svg"
                      width="32"
                      height="32"
                      viewBox="0 0 24 24"
      ...
      ${activities.map(
        (item, index) => html`
          <div class="ale-listbox-option">
            ...
            <div class="ale-listbox-option-inner">
              <h4
