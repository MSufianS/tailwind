...
export const Main: Story = {
  ...
  args: {
    ...
    children: html`
      <h6
        class="ale-heading ale-weight-medium text-muted-800 dark:text-muted-100"
      >
        Iam a card title
      </h6>
      <p
        class="ale-paragraph ale-paragraph-xs text-muted-500 dark:text-muted-400"
      >
...
export const ColorDark: Story = {
  ...
  args: {
    ...
    color: 'dark',
    children: html`
      <h6 class="ale-heading ale-weight-medium text-white dark:text-muted-900">
        Iam a card title
      </h6>
      <p
        class="ale-paragraph ale-paragraph-xs text-muted-200 dark:text-muted-500"
      >
        Iam a nice and lengthy card subtitle
      </p>
    `,
