...
const meta = {
  title: 'Ale UI/Base/Avatar',
  // tags: ['autodocs'],
  render: (args) => Avatar(args),
  argTypes: {
    src: {
      control: { type: 'text' },
      defaultValue: 'https://sufian.online/ale-ui/img/avatars/10.svg',
    },
    srcDark: {
      control: { type: 'text' },
      defaultValue: 'https://sufian.online/ale-ui/img/avatars/10.svg',
...
export const SizeXxsFull: Story = {
  ...
  args: {
    size: 'xxs',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/1.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/1.svg',
  },
}
...
export const SizeXsFull: Story = {
  ...
  args: {
    size: 'xs',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/15.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/15.svg',
  },
}
...
export const SizeMdFull: Story = {
  ...
  args: {
    size: 'md',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/3.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/3.svg',
  },
}
...
export const SizeXlFull: Story = {
  ...
  args: {
    size: 'xl',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/16.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/16.svg',
  },
}
...
export const Size3XlFull: Story = {
  ...
  args: {
    size: '3xl',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/2.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/2.svg',
  },
}
...
export const BadgeXxsFull: Story = {
  ...
  args: {
    ...
    srcDark: 'https://sufian.online/ale-ui/img/avatars/1.svg',
    badgeSrc:
      'https://sufian.online/ale-ui/img/icons/flags/united-states-of-america.svg',
  },
}
...
export const SlotBadge: Story = {
  ...
  args: {
    size: '2xl',
    rounded: 'full',
    src: 'https://sufian.online/ale-ui/img/avatars/20.svg',
    srcDark: 'https://sufian.online/ale-ui/img/avatars/20.svg',
    badge: html`
      <div
