...
Avatars are an essential part of any application. Ale UI avatars can have different sizes, shapes and additional options. They can be used to display uers, companies or any type of visual information.
