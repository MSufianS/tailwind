...
export const Checkbox = ({
  ...
  return html`
    ...
    >
      <div class="ale-checkbox-outer">
        <input
          id="${id}"
          class=${cn('ale-checkbox-input', classes?.input)}
          type="checkbox"
        />
        <div class="ale-checkbox-inner"></div>
        <svg class="ale-icon-check" aria-hidden="true" viewBox="0 0 17 12">
          <path
            fill="currentColor"
      ...
      <div class="ale-checkbox-label-wrapper">
        <label
          for="${id}"
          class=${cn(
