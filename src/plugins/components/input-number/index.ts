...
export default plugin(({ addComponents, theme }) => {
  const config = theme(`ale.${key}`) satisfies InputNumberConfig
  ...
  addComponents({
    ...
    '.ale-input-number-wrapper': {
      '@apply relative': {},
      //Input:label
      '.ale-input-number-label, .ale-label-float': {
        '@apply ale-label': {},
      },
      //Label:float
      '.ale-label-float': {
      ...
      //Input:outer
      '.ale-input-number-outer': {
        '@apply ale-focus relative': {},
      },
      //Input:icon
      '.ale-input-number-icon': {
      ...
      //Input:buttons
      '.ale-input-number-buttons': {
        '@apply absolute top-1 end-1 flex z-10': {},
      },
      //Buttons:button
      '.ale-input-number-buttons > button': {
      ...
      //Rounded:sm
      '&.ale-input-number-rounded-sm': {
        '.ale-input-number, .ale-input-number-outer': {
      ...
      '&.ale-input-number-sm': {
        ...
        '.ale-input-number-icon, .ale-input-number-action': {
          [`@apply h-${config.size.sm.icon.outer.size} w-${config.size.sm.icon.outer.size}`]:
            {},

          '.ale-input-number-icon-inner, .ale-input-number-action-inner': {
      ...
      '&.ale-input-number-default-contrast': {
        '.ale-input-number': {
          //Font
      ...
      //Color:mutedContrast
      '&.ale-input-number-muted-contrast': {
        '.ale-input-number': {
          //Font
      ...
      //Input:not loading
      '&:not(.ale-input-number-loading)': {
        '.ale-input-number:placeholder-shown ~ .ale-label-float': {
          [`@apply text-${config.loaded.font.color.light} dark:text-${config.loaded.font.color.dark}`]:
            {},
        },
      },
      //Input:loading
      '&.ale-input-number-loading': {
        '.ale-input-number': {
      ...
      '&:not(.ale-has-icon).ale-input-number-sm': {
        '.ale-input-number': {
      ...
      //With icon && Size:sm
      '&.ale-has-icon.ale-input-number-sm': {
        '.ale-input-number': {
      ...
      '&:not(.ale-has-icon).ale-input-number-md': {
        '.ale-input-number': {
      ...
      //With icon && Size:md
      '&.ale-has-icon.ale-input-number-md': {
        '.ale-input-number': {
      ...
      '&:not(.ale-has-icon).ale-input-number-lg': {
        '.ale-input-number': {
      ...
      //With icon && Size:lg
      '&.ale-has-icon.ale-input-number-lg': {
        '.ale-input-number': {
      ...
      '&:not(.ale-has-icon).ale-input-number-xl': {
        '.ale-input-number': {
      ...
      //With icon && Size:xl
      '&.ale-has-icon.ale-input-number-xl': {
        '.ale-input-number': {
      ...
      '&.ale-input-number-label-float.ale-has-icon.ale-input-number-sm': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float:not(.ale-has-icon).ale-input-number-md': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float.ale-has-icon.ale-input-number-md': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float:not(.ale-has-icon).ale-input-number-lg': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float.ale-has-icon.ale-input-number-lg': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float:not(.ale-has-icon).ale-input-number-xl': {
        '.ale-label-float': {
      ...
      '&.ale-input-number-label-float.ale-has-icon.ale-input-number-xl': {
        '.ale-label-float': {
