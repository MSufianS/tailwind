...
const meta = {
  title: 'Ale UI/Form/Autocomplete',
  // tags: ['autodocs'],
...
const people = [
  {
    ...
    name: 'Kendra W.',
    role: 'Sales Manager',
    img: 'https://media.sufian.online/ale-ui/ale/avatars/10.svg',
  },
  {
    id: 2,
    name: 'Anna L.',
    role: 'Product Manager',
    img: 'https://media.sufian.online/ale-ui/ale/avatars/24.svg',
  },
  {
    id: 3,
    name: 'Melany C.',
    role: 'Project Manager',
    img: 'https://media.sufian.online/ale-ui/ale/avatars/25.svg',
  },
  {
    id: 4,
    name: 'John B.',
    role: 'Senior Accountant',
    img: 'https://media.sufian.online/ale-ui/ale/avatars/8.svg',
  },
]
...
export const Main: Story = {
  ...
  args: {
    ...
    items: html`
      ${languages.map(
        (item) => html`
          <div class="ale-autocomplete-results-item">
            <div class="ale-autocomplete-results-item-inner">
              <span>${item.name}</span>
            </div>
          </div>
        `,
...
export const Multiple: Story = {
  ...
  args: {
    ...
    chips: html`
      <li>
        <div class="ale-autocomplete-multiple-list-item">
          <span>Javascript</span>
          <button type="button">
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
              class="ale-autocomplete-multiple-list-item-icon"
            >
              <path
                fill="none"
                stroke="currentColor"
...
export const SlotIconSm: Story = {
  ...
  args: {
    ...
    icon: html`
      <svg
        class="ale-autocomplete-icon-inner"
        xmlns="http://www.w3.org/2000/svg"
        width="32"
        height="32"
        viewBox="0 0 24 24"
        ...
        (item) => html`
          <div class="ale-autocomplete-results-item">
            <div class="ale-autocomplete-results-item-inner">
              ...
              <div>
                <h4
                  class="ale-heading ale-heading-sm ale-weight-medium text-muted-800 dark:text-white"
                >
                  ${item.title}
                </h4>
                <p class="ale-paragraph ale-paragraph-xs text-muted-400">
                  ${item.subtitle}
                </p>
              </div>
              <div class="ale-autocomplete-results-item-selected">
                <svg
                  class="ale-autocomplete-results-item-selected-icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
                  viewBox="0 0 24 24"
