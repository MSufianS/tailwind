...
export const Breadcrumb = ({
  ...
  return html`
    <nav
      ...
      ${spread(attrs)}
    >
      <ul class="ale-breadcrumb-list">
        <li class="ale-breadcrumb-item-mobile">
          ${Dropdown({
            variant: 'context',
            size: 'md',
            children: html`
        ...
        ${items?.map(
          (item, index) => html`
            ...
            >
              <a
                href="${item.href}"
                class=${cn('ale-item-inner', item.href && 'ale-has-link')}
              >
                <svg
                  class="ale-item-icon"
            ...
            <li class="ale-breadcrumb-item">
              <div class="ale-item-inner">
                ${index < items.length - 1 && separator === 'dot'
                  ? html`
                      <span class="ale-item-text">·</span>
                    `
                  : ''}
